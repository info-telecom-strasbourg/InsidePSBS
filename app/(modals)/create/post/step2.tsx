...
import type { StorePostData } from "@app/(modals)/create/post/_features/fetch/store-post.schema";
import { StorePostSchema } from "@app/(modals)/create/post/_features/fetch/store-post.schema";
