...
const ProfilePage = ({  }) => {
  ...
  return (
    ...
    <View style={{flexDirection:"column", backgroundColor:primaryColor,flex:1,justifyContent:'space-between',alignContent:'center'}}>
      ...
      <Text style={{fontSize:20,textAlign:'center', flex:1,color:'white',alignSelf:'center',justifyContent:'flex-end',flexDirection:'column'}}>Application développé par {'\n'}Gatien Chenu et Félix Lusseau.{'\n'} Graphisme réalisé par {'\n'}Jeanne König-Wacheux</Text>
      <Text style={{flex:1,color:'white',alignSelf:'center',justifyContent:'flex-end',flexDirection:'column'}}>Version 1.0.0</Text>
